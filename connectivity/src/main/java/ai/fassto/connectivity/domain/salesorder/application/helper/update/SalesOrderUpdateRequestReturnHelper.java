...
@Component
public class SalesOrderUpdateRequestReturnHelper extends SalesOrderUpdateRequestHelper{
    private final OrderType ORDER_TYPE = OrderType.RETURN; //반출

    public SalesOrderUpdateRequestReturnHelper(SalesOrderRepository salesOrderRepository) {
